...
@Component({
  ...
  template: `
    <div class="max-w-6xl mx-auto p-6 space-y-6">
      <!-- SIMULADOR DE ROLES -->
      <div
        class="bg-indigo-50 p-4 rounded-xl border border-indigo-200 flex justify-between items-center shadow-sm"
      >
        <div>
        ...
        <select
          ...
          class="font-medium text-sm border-indigo-300 rounded-lg shadow-sm text-indigo-900 bg-white"
        >
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200 text-sm">
          <thead class="bg-gray-50">
            <tr>
              <th
                class="px-6 py-3 text-left font-semibold text-gray-500 uppercase tracking-wider text-xs"
              >
                Nro OC
              </th>
              <th
              ...
              <th
                class="px-6 py-3 text-right font-semibold text-gray-500 uppercase tracking-wider text-xs"
              >
                Monto
              </th>
              <th
                class="px-6 py-3 text-center font-semibold text-gray-500 uppercase tracking-wider text-xs"
              >
                Estado
              </th>
              <th
              ...
              <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-4 text-center">
                  <button
                    ...
                    class="text-blue-600 hover:text-blue-900 font-medium text-xs bg-blue-50 px-3 py-1.5 rounded-lg hover:bg-blue-100 transition-colors"
                  >
                    Ver Detalle
                  </button>
                </td>
