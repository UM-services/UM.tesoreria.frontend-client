  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-gradient-to-br from-purple-600 to-fuchsia-700 md:col-start-3 overflow-hidden shadow-md rounded-xl p-6 text-white flex flex-col justify-between">
          <div>
            <h3 class="text-lg font-medium">Chequeras</h3>
            <p class="mt-1 text-sm text-purple-100 opacity-80">Gestione el cobro de cuotas y series desde el menú.</p>
          </div>
